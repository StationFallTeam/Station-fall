...
def render_menu_screen(win, screen_width, screen_height, background, menu_camera_x, menu_camera_y, truck_img, float_time):
    background.update_and_draw(win, (menu_camera_x, menu_camera_y))
    return draw_menu(win, screen_width, screen_height, truck_img, float_time)

def render_inventory_screen(win, player, enemies, bullets, walls, camera, background, coins, inventory_ui):
    draw_objects(win, player, enemies, bullets, walls, camera, background, coins)

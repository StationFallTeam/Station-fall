    ...
    PAGES = [
        {
            ...
            "lines": [
                ...
                "Fight through combat zones, collect resources,",
                "and make it back to the hub alive.",
                "",
                "Look for interaction prompts at the bottom-left",
                "of your screen when standing near terminals.",
            ],
        },
        {
            "icon": "[]",
            "heading": "Movement & Tactics",
            "lines": [
                "W, A, S, D  —  move your pilot",
                "",
                "Tactical Facing: You always face the last",
                "direction moved. Use this to orient your",
                "sprite before engaging in tight corridors.",
            ],
        },
        {
            "icon": "(*)",
            ...
            "lines": [
                "Melee Units: Will chase you directly to deal",
                "contact damage. Don't let them corner you!",
                "",
                "Ranged Units: These scouts try to stay at a",
                "distance. If you get too close, they will",
                "retreat while continuing to fire.",
            ],
        },
        {
            "icon": "!",
            "heading": "Invincibility Frames",
            "lines": [
                "Both YOU and ENEMIES gain a brief shield (0.5s)",
                "after taking damage. During this time, no",
                "additional damage can be dealt.",
                "",
                "Wait for the 'flash' to end before firing your",
                "next shot to ensure maximum efficiency.",
            ],
        },
        {
            "icon": "[$]",
            "heading": "Upgrades & Inventory",
            "lines": [
                "E  —  Shop  |  I  —  Inventory",
                "",
                "Blaster Upgrade: Increases damage per bolt.",
                "Suit Upgrade: Increases max HP capacity.",
                "",
                "Note: Projectiles have a limited range and will",
                "self-destruct after a short flight time.",
            ],
        },
        {
            "icon": "[>]",
            "heading": "Dungeon Protocol",
            "lines": [
                "ENTER  —  travel via the hub portal",
                "R       —  return (ONLY when rooms are clear)",
                "",
                "The minimap tracks your position. Combat",
                "rooms lock automatically. You cannot leave",
                "the station until every threat is neutralized!",
            ],
        },
    ]

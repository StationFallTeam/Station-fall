    ...
    PAGES = [
        {
            ...
            "lines": [
                "Hello, Pilot there have been recent developments",
                "Station Orange and Station Pink have gone rogue.",
                "Its up to you to infiltrate and restore order!",
                "",
        ...
        },
        {
            ...
            "heading": "Combat",
            "lines": [
                "Left click - Fire your high-energy Blaster.",
                "",
                "Sheild: When you or an enemy takes a hit,",
                "a brief 0.5s invincibility shield activates.",
                "Don't waste ammo, wait for the shield to shut down!",
                "",
                "Drops: Scavenge drops from fallen foes",
                "including health and coins"
            ],
        },
        {
            "icon": "[!]",
            ...
            "lines": [
                ...
                "",
                "Boss: Not much is known about them, but they lurk far from",
                "the stations center"
            ],
        },
        {
        ...
        },
        {
            ...
            "heading": "System Keys",
            "lines": [
                "Enter — Terminal: Launch your mission from the SF Terminal.",
